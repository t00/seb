...
JSC::EncodedJSValue JSC_HOST_CALL jsDOMWindowPrototypeFunctionCreateObjectURL(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsDOMWindowPrototypeFunctionRevokeObjectURL(JSC::ExecState*);
// Attributes
