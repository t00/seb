...
JSC::JSValue jsDocumentOnformchange(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDocumentOnformchange(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsDocumentOnforminput(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDocumentOnforminput(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
