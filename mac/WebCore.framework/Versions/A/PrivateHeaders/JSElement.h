...
JSC::JSValue jsElementOnformchange(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSElementOnformchange(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsElementOnforminput(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSElementOnforminput(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
