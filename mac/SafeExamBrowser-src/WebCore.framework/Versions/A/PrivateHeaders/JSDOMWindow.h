...
JSC::JSValue jsDOMWindowOnformchange(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowOnformchange(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsDOMWindowOnforminput(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowOnforminput(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
