...
// Set up SEB Browser 
#pragma mark Set up SEB Browser        
...
//    id myDocument = [[NSDocumentController sharedDocumentController] currentDocument];
    id myDocument = [[NSDocumentController sharedDocumentController] openUntitledDocumentOfType:@"DocumentType" display:YES];
    webView = [myDocument webView];
    [webView retain];
    browserWindow = [[myDocument webView] window]; 
    [browserWindow retain];
	[browserWindow
