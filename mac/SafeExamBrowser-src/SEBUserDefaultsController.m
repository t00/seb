...
#import "SEBUserDefaultsController.h"

@implementation SEBUserDefaultsController

- (NSArray *) newBrowserWindowByLinkPolicies {
...
- (NSArray *) newBrowserWindowByScriptPolicies {
    return [NSArray arrayWithObjects:NSLocalizedString(@"get generally blocked", nil), NSLocalizedString(@"open in same window", nil), NSLocalizedString(@"open in new window", nil), nil];
}

- (NSArray *) chooseFileToUploadPolicies {
