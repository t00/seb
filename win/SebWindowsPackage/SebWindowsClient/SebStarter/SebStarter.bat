...
echo.
echo PermittedApplications=VMwareViewClient,"C:\Program Files\VMware\VMware View\Client\bin\wswc.exe";
echo.
echo.
...
echo.
echo PermittedApplications=VMwareViewClient,wswc.exe;
echo.
