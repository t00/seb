...
#define PRODUCT_NAME      "SEB Windows 1.9.1"
#define APP_CHOOSER_TITLE "Safe Exam Browser 1.9.1"
...
char localAppDataDirectory[MAX_PATH];
...
void SetIniFileDirectoryAndName()
{
  ...
  //strcpy(iniFileDirectory , "C:\\ProgramData\\ETH Zuerich\\SEB Windows 1.9.1");
...
void SetLogFileDirectoryAndName()
{
  ...
  //strcpy(logFileDirectory , "C:\\ProgramData\\ETH Zuerich\\SEB Windows 1.9.1");
