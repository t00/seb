    ...
    public class SEBEditRegistry
    {
        ...
        public bool EditRegistry()
        {
            try
	        {
                ...
                if (!(Boolean)SEBClientInfo.getSebSetting(SEBSettings.MessageInsideSebEnableSwitchUser)[SEBSettings.MessageInsideSebEnableSwitchUser])
		        {
                ...
                if (!(Boolean)SEBClientInfo.getSebSetting(SEBSettings.MessageInsideSebEnableLockThisComputer)[SEBSettings.MessageInsideSebEnableLockThisComputer]) 
		        {
                ...
                if (!(Boolean)SEBClientInfo.getSebSetting(SEBSettings.MessageInsideSebEnableChangeAPassword)[SEBSettings.MessageInsideSebEnableChangeAPassword]) 
		        {
                ...
                if (!(Boolean)SEBClientInfo.getSebSetting(SEBSettings.MessageInsideSebEnableStartTaskManager)[SEBSettings.MessageInsideSebEnableStartTaskManager]) 
		        {
                ...
                if (!(Boolean)SEBClientInfo.getSebSetting(SEBSettings.MessageInsideSebEnableLogOff)[SEBSettings.MessageInsideSebEnableLogOff]) 
		        {
                ...
                if (!(Boolean)SEBClientInfo.getSebSetting(SEBSettings.MessageInsideSebEnableShutDown)[SEBSettings.MessageInsideSebEnableShutDown]) 
		        {
                ...
                if ((Boolean)SEBClientInfo.getSebSetting(SEBSettings.MessageInsideSebEnableEaseOfAccess)[SEBSettings.MessageInsideSebEnableEaseOfAccess]) 
		        {
                ...
                if ((Boolean)SEBClientInfo.getSebSetting(SEBSettings.MessageInsideSebEnableVmWareClientShade)[SEBSettings.MessageInsideSebEnableVmWareClientShade]) 
		        {
