...
*/
        ...
        // ************************************************************
        private static void GetSubKeysLocalMachine(RegistryKey subKey, ref LinkedList<String> subKeyNames)
        {
        ...
        // **************************************************
        private static LinkedList<String> GetSids()
        {
        ...
        // ************************************
        private static String GetSidByUsername(String userName)
        {
        ...
        // *********************************************************************
        private static String EditOneRegistryValue(String userName, String userSid,
        ...
        // ****************************************************************
        private static void EditAllRegistryValues(int wishedSettings, int editMode)
        {
            int  regIndex;
